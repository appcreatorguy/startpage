...
export const config: Config = {
  ...
  lists: [
    ...
    [
      {
        icon: "share-nodes", // Icon for the list to use. The same as the buttons.
        links: [
          {
            name: "Spotify", // Display text for the link
            url: "https://www.spotify.com", // URL to the page
          },
          {
            name: "Reddit",
      ...
      },
      {
        ...
        links: [
          {
            name: "Core Pure 1",
            url: "https://www.physicsandmathstutor.com/maths-revision/solutionbanks/edexcel-core-pure-maths-1/",
          },
          {
            name: "Stats & Mech Y2",
            url: "https://www.physicsandmathstutor.com/maths-revision/solutionbanks/edexcel-statistics-mechanics-year-2/",
          },
          {
            name: "Notion",
    ...
    [
      ...
      },
      {
        ...
        links: [
          ...
          {
            name: "Repos",
            url: "https://github.com/appcreatorguy",
          },
        ],
      },
    ],
